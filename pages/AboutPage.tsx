...
const AboutPage: React.FC = () => {
  return (
    <>
      <title>About Vagdevi Foods - Our Story, Mission, and Values</title>
      <meta name="description" content="Learn about Vagdevi Foods, a leading rice milling and processing company in Telangana, India. Discover our commitment to quality, trust, and reliable supply." />
