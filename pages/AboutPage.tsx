...
const AboutPage: React.FC = () => {
  const structuredData = {
    ...
    "description": "Learn about our journey, our commitment to quality, and the tradition behind Vagdevi Food Products.",
    "mainEntity": {
      "@type": "Organization",
  ...
  return (
    <div className="bg-brand-bg font-sans pt-12 md:pt-16"> {/* Added top padding here */}
      <SEO
        ...
        keywords="about vagdevi foods, rice mill telangana, food products company history"
