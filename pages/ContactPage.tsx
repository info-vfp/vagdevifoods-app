...
const ContactPage: React.FC = () => {
  ...
  return (
    <>
      <title>Contact Vagdevi Foods - B2B Rice Suppliers</title>
      <meta name="description" content="Contact Vagdevi Foods for B2B inquiries, partnerships, and bulk orders of our premium rice products. We are here to help you with your needs." />
