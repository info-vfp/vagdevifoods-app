...
const MarketsPage: React.FC = () => {
  return (
    <>
      <title>Our Markets - Vagdevi Foods</title>
      <meta name="description" content="Vagdevi Foods has a strong market presence in Telangana, Andhra Pradesh, Karnataka, and other states. We are a reliable supplier of premium quality rice to wholesalers and distributors." />
