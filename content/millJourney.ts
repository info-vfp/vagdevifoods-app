...
export const MILL_STAGES: MillStage[] = [
  {
    ...
    src: 'images/mill/weighbridge.png', pos: 'center 60%',
  ...
  },
  {
    ...
    src: 'images/mill/intake_sampling.png', pos: 'center',
  ...
  },
  {
    ...
    src: 'images/mill/quality_lab.png', pos: 'center 30%',
  ...
  },
  {
    ...
    src: 'images/mill/unloading.png', pos: 'center',
  ...
  },
  {
    ...
    src: 'images/mill/mysilo.png', pos: 'center',
  ...
  },
  {
    ...
    src: 'images/mill/satake_polishers.png', pos: 'center',
  ...
  },
  {
    ...
    src: 'images/mill/rice_belt.png', pos: 'center',
  ...
  },
  {
    ...
    src: 'images/mill/stitching_bags.png', pos: 'center',
...
export const HOME_MILL_STEPS: HomeMiniStep[] = [
  { n: '01', t: 'Gate sampling', d: 'A probe sample is drawn from every load before it is allowed onto the weighbridge.', src: 'images/mill/intake_sampling.png', pos: 'center' },
  { n: '02', t: 'Moisture & grain lab', d: 'Moisture, immature grain and foreign matter are read on the spot. Out-of-band loads go back.', src: 'images/mill/quality_lab.png', pos: 'center 30%' },
  // Source design references images/mill/dryers.png, which doesn't exist in the asset set — using the
  // equivalent "Drying & silos" stage photo (mysilo.png) from the full Mill Journey instead.
  { n: '03', t: 'Drying & storage', d: 'Mechanical dryers and steel silos hold paddy at a stable moisture through the season.', src: 'images/mill/mysilo.png', pos: 'center' },
  { n: '04', t: 'Milling & polishing', d: 'Hulling, whitening and polishing lines, with bran and husk drawn off for by-product sale.', src: 'images/mill/satake_polishers.png', pos: 'center' },
  { n: '05', t: 'Grading & packing', d: 'Graded, colour-sorted and filled into 10, 26 and 30 kg packs — or your own printed bag.', src: 'images/mill/rice_belt.png', pos: 'center' },
  { n: '06', t: 'Loading & dispatch', d: 'Trucks and containers load in the yard, with paperwork issued the same day.', src: 'images/mill/warehouse_yard.png', pos: 'center 60%' },
];
...
export const MILL_MACHINERY: MachineryItem[] = [
  { tag: 'Steam generation', t: 'A 14-tonne boiler, fired on our own husk', d: 'The husk taken off the paddy fuels the boiler that par-boils the next batch. Nothing is bought in to run it and nothing is dumped.', src: 'images/mill/boiler_14ton.png', pos: 'center' },
  { tag: 'Storage', t: 'Paddy held in bulk, not in stacks', d: 'A warehouse floor built to hold season-scale volume, so we buy when the farmer is selling rather than when the market forces us to.', src: 'images/mill/paddy_mountain.png', pos: 'center' },
  { tag: 'Quality control', t: 'Every stream on one plate', d: 'Paddy, brown rice, polished rice, broken and bran — drawn from the same lot and checked side by side before a consignment is cleared.', src: 'images/mill/grain_samples.png', pos: 'center' },
];
...
export const MILL_MOSAIC: MosaicItem[] = [
  { src: 'images/mill/paddy_inspection.png', pos: 'center', cap: 'Paddy read by hand at the elevator, every shift' },
  { src: 'images/mill/chute_operator.png', pos: 'center', cap: 'Flow control at the intake chute' },
  { src: 'images/mill/procurement_hall.png', pos: 'center', cap: 'The farmer counter — weight, moisture and payment in one visit' },
  { src: 'images/mill/shift_change.png', pos: 'center', cap: 'Shift change at the main gate' },
];
